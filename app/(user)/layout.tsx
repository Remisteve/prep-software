...
const Layout = ({ children }: { children: ReactNode }) => {
    ...
    const sections = useMemo(() => [
        { id: 'dashboard', label: 'Dashboard', icon: Home, path: '/my-dashboard' },
        { id: 'enrollment', label: 'Enrollment', icon: User, path: '/enrollments' },
        { id: 'facilities', label: 'Facilities', icon: MapPin, path: '/facilities' },
        { id: 'appointments', label: 'Appointments', icon: Calendar, path: '/appointments' },
        { id: 'resources', label: 'Educational Resources', icon: BookOpen, path: '/resources' },
        { id: 'services', label: 'Health Services', icon: Shield, path: '/services' },
